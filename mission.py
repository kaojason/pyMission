                ...
                SerialSystem('segment',
                        ...
                        SerialSystem('coupled_analysis',
                                ...
                                SerialSystem('drag',
                                             ...
                                             PC_atol=1e-10,
                                             subsystems=[
                                        IndVar('CL', val=numpy.ones(self.num_elem)),
                                        IndVar('CD', val=numpy.ones(self.num_elem)),
                                        IndVar('alpha', val=numpy.zeros(self.num_elem)),
                                        #SysAlpha('alpha',
                                        #         num_elem=self.num_elem),
                                ...
                                SerialSystem('hor_eqlm',
                                             ...
                                             LN_atol=1e-10,
                                             subsystems=[
                                        IndVar('CT_tar', val=numpy.ones(self.num_elem)),
                                        #SysCTTar('CT_tar',
                                        #         num_elem=self.num_elem),
                                        ]),
                                SerialSystem('mmt_eqlm',
                                             ...
                                             LN_atol=1e-10,
                                             subsystems=[
                                        IndVar('eta', val=numpy.zeros(self.num_elem)),
